...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/bufferToggle.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/bufferToggle.ts</span></h1>
    <h2>
        Statements: <span class="metric">98.91% <small>(91 / 92)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">75% <small>(3 / 4)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(21 / 21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">98.82% <small>(84 / 85)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; bufferToggle.ts</div>
</div>
<div class="body">
...
&nbsp;
  closeBuffer(context: BufferContext&lt;T&gt;) {
    const contexts = this.contexts;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (contexts === null) {
