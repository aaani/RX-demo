...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operator/skipUntil.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operator/skipUntil.js</span></h1>
    <h2>
        Statements: <span class="metric">97.44% <small>(38 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">76.92% <small>(10 / 13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(12 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.22% <small>(35 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operator/</a> &#187; skipUntil.js</div>
</div>
<div class="body">
...
var SkipUntilSubscriber = (function (_super) {
    ...
    SkipUntilSubscriber.prototype.notifyComplete = function () {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isStopped) {
<span class="cstat-no" title="statement not covered" >            _super.prototype._complete.call(this);</span>
        }
    };
    return SkipUntilSubscriber;
})(OuterSubscriber_1.OuterSubscriber);
//# sourceMappingURL=skipUntil.js.map</pre></td></tr>
</table></pre>
