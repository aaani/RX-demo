...
define(["require", "exports", '../../Subject', '../../Subscriber', '../../Observable', '../../Subscription', '../../util/root', '../../subject/ReplaySubject', '../../util/tryCatch', '../../util/errorObject', '../../util/assign'], function (require, exports, Subject_1, Subscriber_1, Observable_1, Subscription_1, root_1, ReplaySubject_1, tryCatch_1, errorObject_1, assign_1) {
    var WebSocketSubject = (function (_super) {
        __extends(WebSocketSubject, _super);
        function WebSocketSubject(urlConfigOrSource, destination) {
            if (urlConfigOrSource instanceof Observable_1.Observable) {
                _super.call(this, urlConfigOrSource, destination);
            }
            else {
                _super.call(this);
