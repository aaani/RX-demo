...
<html lang="en">
<head>
    <title>Code coverage report for cjs/operator/withLatestFrom.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">cjs/operator/withLatestFrom.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">cjs/operator/</a> &#187; withLatestFrom.js</div>
</div>
<div class="body">
    ...
    WithLatestFromSubscriber.prototype._next = function (value) {
        if (this.toRespond.length === 0) {
            ...
            if (project) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (result === errorObject_1.errorObject) {
