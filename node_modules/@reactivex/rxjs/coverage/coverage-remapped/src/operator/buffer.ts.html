...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/buffer.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/buffer.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; buffer.ts</div>
</div>
<div class="body">
