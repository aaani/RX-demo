...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/windowTime.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/windowTime.ts</span></h1>
    <h2>
        Statements: <span class="metric">100% <small>(80 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">80% <small>(12 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(14 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(76 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; windowTime.ts</div>
</div>
<div class="body">
...
export function windowTime&lt;T&gt;(windowTimeSpan: number,
                              <span class="missing-if-branch" title="if path not taken" >I</span>windowCreationInterval: number = null,
                              <span class="missing-if-branch" title="if path not taken" >I</span>scheduler: Scheduler = asap): Observable&lt;Observable&lt;T&gt;&gt; {
