...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/bufferWhen.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/bufferWhen.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; bufferWhen.ts</div>
</div>
<div class="body">
...
&nbsp;
  _complete() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (buffer) {
