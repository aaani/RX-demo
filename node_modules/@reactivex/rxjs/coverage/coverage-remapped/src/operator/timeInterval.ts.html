...
<html lang="en">
<head>
    <title>Code coverage report for src/operator/timeInterval.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/operator/timeInterval.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">src/operator/</a> &#187; timeInterval.ts</div>
</div>
<div class="body">
...
&nbsp;
export function timeInterval&lt;T&gt;(<span class="missing-if-branch" title="if path not taken" >I</span>scheduler: Scheduler = asap): Observable&lt;TimeInterval&gt; {
